...
final_dict_keys = ['FileName', 'File Language', 'Personal Details', 'Current Job', 'Total Experience(years)', 'Experience', 'Education', 'Skills', 'Reference', 'Awards','email', 'phone', 'name', 'total_exp', 'university', 'designition', 'degree', 'skills', 'Companies worked at']
